...
const Cart = () => {
  ...
  if (!jwtToken) {
    console.log("jwtToken is not present in local storage, error while loading cart page!");
    return;
  }
  const [cartItems, setCartItems] = useState();

  const cartLoadFxn = async () => {
    try {
      const res = await fetch(`${configObject.BACKEND_URL}/cart`, {
        method: 'GET',
        headers: {
      ...
      console.log("Error while loading cart items in the cart.jsx page",err);
    }
  }
